<template>
  <div class="login-wrapper">
    ...
    <div style="display: block; text-align: center; margin-top: 80px;">
        <img alt="Logo" src="@/assets/logo.png" style="width: 120px;"/>
        <h1 style="font-size: 28px; margin: 30px 0;">攝影師 My Space 登入</h1>
      </div>
...
export default {
  ...
  data() {
    ...
    return {
      appVersion: localStorage.getItem('JS_P_VERSION'),
      showLoading: true,
      ...
      rules: {
        ...
        password: [
          ...
          // {min: 6, max: 15, message: '密碼需 6~8 碼', trigger: 'blur'}
        ],
      }
    }
  },
  ...
  methods: {
    ...
    checkReload(){
      ...
      if (this.appVersion === null) {
        localStorage.setItem('JS_P_VERSION', this.version)
