        ...
        <el-card class="box-card">
          <el-form label-position="top"
            ...
            <el-row>
              ...
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                  <el-tooltip class="item" effect="dark" content="接收Line訊息通知" placement="top-start">
                    <el-button type="success" @click="connectLine" icon="el-icon-chat-line-round">LINE Notify</el-button>
                  </el-tooltip>
                  (接收Line訊息通知)
                </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :xs="24" :sm="24" :md="24" :lg="14" class="pr-20">
                <el-form-item label="攝影師介紹" prop="intro">
                  <el-input type="textarea" :rows="8" lazy v-model="form.intro"></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="24" :lg="6">
              ...
              <!-- <el-col :xs="24" :sm="24" :md="24" :lg="6">
                <el-form-item :label="`星等評價 ${form.rating?form.rating:''}`">
                  <el-slider v-model="form.rating" :marks="marks" :step="0.1" :min="1" :max="5">
                  </el-slider>
                </el-form-item>
              </el-col> -->
...
export default {
    ...
    saveData(formName) {
      this.$refs[formName].validate(async valid => {
        if (valid) {
          ...
          this.request.post("/photographer", this.form).then(async res => {
            if (res.code === '200') {
  ...
  mounted() {
    ...
    console.log('basic info:', this.pid)
    this.loadServiceCat()
  }
}
</script>
