<template>
	<div>
		<el-card class="box-card mb-20" >
			<div class="upload-container">
		        ...
		        :on-change="avatarChanged">
				  ...
				  <div slot="tip" class="el-upload__tip">檔案單張限2M</div>
				</el-upload>
			</div>
		</el-card>
		...
		<!-- <el-card class="box-card mb-20" >
			...
			<el-row class="mt-20 text-right">
	      <el-col :xs="24" :sm="24" :lg="24">
	        <el-button type="primary" @click.prevent="uploadAll" class="ml-20"><i class="el-icon-upload">確認上傳</i>
	        </el-button>
	      </el-col>
	    </el-row>
		</el-card> -->
