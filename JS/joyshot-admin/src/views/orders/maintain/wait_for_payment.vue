          ...
          <el-table id="product_table" :data="tableData" empty-text="無資料" stripe header-row-class-name="headerStyle">
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                ><el-button class="mt-10" size="mini" type="primary" slot="reference"> <i class="el-icon-tickets"></i> 付款提醒</el-button>
                </el-popconfirm>
...
export default {
    ...
    getData(){
      ...
      this.request.get('/order/status/processing', {params:query}).then(res => {
        if (res.code === "200") {
